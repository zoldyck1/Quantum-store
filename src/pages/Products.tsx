...
const Products: React.FC = () => {
    ...
    const { products, categories, selectedCategory, searchQuery, loading, error } = useSelector((state: RootState) => state.products)
    ...
    useEffect(() => {
        ...
        const testConnection = async () => {
            try {
                ...
                // @ts-ignore - Assuming productService.testConnection exists in JS service
    ...
    const fallbackProducts: any[] = [
        {
            id: 1,
            name: 'Sample Digital Product', // changed from title to name to match interface
