...
const CMIPayment = ({ orderData, onPaymentInitiated }) => {
      ...
      <form onSubmit={handlePayment} className="space-y-4">
        ...
        <div className="pt-4">
          <button
            type="submit"
            disabled={loading}
            className={`w-full flex items-center justify-center px-6 py-3 border border-transparent rounded-md text-base font-medium text-white ${
              loading 
